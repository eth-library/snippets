            ...
            r = function() {
                            ...
                            return n(this, (function(e) {
                                switch (e.label) {
                                    case 0:
                                        return [4, r()];
                                    case 1:
                                        return e.sent() && document.removeEventListener(t, o), [2]
                                }
                            }))
                        }))
                    };
                    ...
                    var i = function(o) {
                        return e(this, void 0, void 0, (function() {
                            return n(this, (function(e) {
                                switch (e.label) {
                                    case 0:
                                        return o.storageArea !== localStorage || o.key !== t ? [3, 2] : [4, r()];
                                    case 1:
                                        e.sent() && window.removeEventListener("storage", i), e.label = 2;
                                    case 2:
                                        return [2]
                                }
                            }))
                ...
                var f = function() {
                    ...
                    return f.prototype._init = function() {
                        ...
                        var t = o(o([], r(this._getClientIds())), [this._clientId]);
                        ...
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(o) {
                                return r = this, [2, new Promise((function(o, i) {
                                    return e(this, void 0, void 0, (function() {
                                        var e, a, s, l, c, f, d, p, _;
                                        return n(this, (function(n) {
                                            if (!(e = r._handleRequestArgs(t, i))) return [2];
                                            if (a = e.cb, s = e._options, l = t[0], c = {
                                                    ...
                                                    resolve: o,
                                                    reject: i
                                                }, f = r._resolveWithCB(a, o, i), d = r._heldLockSet(), p = d.find((function(t) {
                                                    return t.name === c.name
                                                })), _ = r._requestLockQueueMap()[c.name] || [], !0 === s.steal) {
                                                if (!r._handleExceptionWhenStealIsTrue(s, i)) return [2];
                                                ...
                                                if (void 0 !== s.signal && !r._handleSignalExisted(s, i, c)) return [2]
                                            }
                        ...
                        var e = this._requestLockQueueMap(),
                            n = e[t.name] || [];
                        return e[t.name] = o(o([], r(n)), [t]), this._storeRequestLockQueueMap(e), t
                        ...
                        if (-1 !== n) {
                            e.splice(n, 1);
                            var i = this._requestLockQueueMap(),
                                a = i[t.name] || [],
                                s = r(a),
                                l = s[0],
                                c = s.slice(1);
                            if (l) {
                                if (l.mode === u.EXCLUSIVE || 0 === c.length) e.push(l), i[t.name] = c;
                                else if (l.mode === u.SHARED) {
                                    var h = a.findIndex((function(t) {
                                        return t.mode !== u.SHARED
                                    })); - 1 === h && (h = a.length), e = o(o([], r(e)), r(a.splice(0, h)))
                                }
                                return this._storeHeldLockSetAndRequestLockQueueMap(e, i), l
                            }
                        ...
                        var r, o, i = e.length;
                        if (i < 2) return n(new TypeError("Failed to execute 'request' on 'LockManager': 2 arguments required, but only " + e.length + " present.")), null;
                        if (2 === i) {
                            ...
                            r = e[2], o = t(t({}, this._defaultOptions), e[1])
                        }
                        return Object.values(u).indexOf(o.mode) < 0 ? (n(new TypeError("Failed to execute 'request' on 'LockManager': The provided value '" + o.mode + "' is not a valid enum value of type LockMode.")), null) : "-" === e[0][0] ? (n(new DOMException("Failed to execute 'request' on 'LockManager': Names cannot start with '-'.")), null) : {
                            cb: r,
                            _options: o
                        }
                    }, f.prototype._handleHeldLockAndRequest = function(t, e, n, r, o) {
                        t ? t.mode === u.EXCLUSIVE ? this._handleNewLockRequest(e, n) : t.mode === u.SHARED && (e.mode === u.SHARED && 0 === r.length ? this._handleNewHeldLock(e, n, o) : this._handleNewLockRequest(e, n)) : this._handleNewHeldLock(e, n, o)
                    ...
                    }, f.prototype._resolveWithCB = function(t, r, o) {
                        var i = this;
                        return function(a) {
                    ...
                    }, f.prototype._handleNewHeldLock = function(t, r, o) {
                        return e(this, void 0, void 0, (function() {
                            var e, i, a, s = this;
                            return n(this, (function(n) {
                                return this._pushToHeldLockSet(t, o), e = !1, i = !1, a = function() {
                                    return !(e || i || s._isInHeldLockSet(t.uuid) || (s._handleHeldLockBeSteal(t), i = !0, 0))
                        ...
                        l(c.HELD_LOCK_SET, (function() {
                            return e(o, void 0, void 0, (function() {
                                return n(this, (function(e) {
                                    switch (e.label) {
                                        case 0:
                                            return i || !this._isInHeldLockSet(t.uuid) ? [3, 5] : (i = !0, [4, r({
                                                name: t.name,
                                                mode: t.mode
                                            })]);
                                        case 1:
                        ...
                        return n.forEach((function(n) {
                            if (n.clientId !== e) i.push(n);
                                ...
                                var a = t[n.name] || [],
                                    ...
                                    c = s.slice(1);
                                if (l)
                                    if (l.mode === u.EXCLUSIVE || 0 === c.length) i.push(l), t[n.name] = c;
                                    else if (l.mode === u.SHARED) {
                                    var h = a.findIndex((function(t) {
                                        return t.mode !== u.SHARED
                                    })); - 1 === h && (h = a.length), i = o(o([], r(i)), r(a.splice(0, h)))
                                }
                            }
                        })), i
                        ...
                        var t = this,
                            e = o([], r(new Set(this._getClientIds())));
                        if (e.length) {
                            var n = [];

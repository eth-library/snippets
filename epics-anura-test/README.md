...
# Lösung
Die Datei **banner.json** wird vom anura-Code via https://eth-library.github.io/snippets/epics-anura-test/banner.json gelesen.

Steht in dieser Datei ein 'info' Objekt, dann wird der Text im anura Frontend angezeigt. Ausnahme: Der Info-Banner für alle anura Frontends (https://github.com/eth-library/snippets/tree/main/epics-anura) ist aktiv. Dann wird immer nur der Info-Banner für alle anura Frontends angezeigt.
